...
from app.sadtalker.face3d.models import networks

from app.sadtalker.facerender.modules.keypoint_detector import HEEstimator, KPDetector
from app.sadtalker.facerender.modules.mapping import MappingNet
from app.sadtalker.facerender.modules.generator import OcclusionAwareGenerator, OcclusionAwareSPADEGenerator

from app.sadtalker.audio2pose_models.audio2pose import Audio2Pose
from app.sadtalker.audio2exp_models.networks import SimpleWrapperV2
from app.sadtalker.test_audio2coeff import load_cpk

size = 256
############ face vid2vid
config_path = os.path.join('.app/sadtalker', 'config', 'facerender.yaml')
...
audio2pose_yaml_path = os.path.join(current_root_path, 'sadtalker', 'config', 'auido2pose.yaml')

audio2exp_checkpoint = os.path.join(current_root_path, 'checkpoints', 'auido2exp_00300-model.pth')
audio2exp_yaml_path = os.path.join(current_root_path, 'sadtalker', 'config', 'auido2exp.yaml')
