...
import numpy as np
from app.vallex.data.tokenizer import (
    AudioTokenizer,
    tokenize_audio,
)
from app.vallex.data.collation import get_text_token_collater
from app.vallex.models.vallex import VALLE
from app.vallex.utils.g2p import PhonemeBpeTokenizer
from app.vallex.utils.sentence_cutter import split_text_into_sentences

from app.vallex.macros import *
...
checkpoints_dir = "./app/vallex/checkpoints/"
...
text_tokenizer = PhonemeBpeTokenizer(tokenizer_path="./app/vallex/utils/g2p/bpe_69.json")
    ...
    if not os.path.exists(os.path.join(checkpoints_dir, model_checkpoint_name)):
        ...
        try:
            ...
            wget.download("https://huggingface.co/Plachta/VALL-E-X/resolve/main/vallex-checkpoint.pt",
                          out="./app/vallex/checkpoints/vallex-checkpoint.pt", bar=wget.bar_adaptive)
