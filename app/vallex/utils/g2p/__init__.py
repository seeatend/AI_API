...
import app.vallex.utils.g2p.cleaners
from app.vallex.utils.g2p.symbols import symbols
...
class PhonemeBpeTokenizer:
  def __init__(self, tokenizer_path = "./app/vallex/utils/g2p/bpe_1024.json"):
...
def _clean_text(text, cleaner_names):
  for name in cleaner_names:
    cleaner = getattr(app.vallex.utils.g2p.cleaners, name)
    if not cleaner:
