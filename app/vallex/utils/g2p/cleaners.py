import re
from app.vallex.utils.g2p.japanese import japanese_to_romaji_with_accent, japanese_to_ipa, japanese_to_ipa2, japanese_to_ipa3
from app.vallex.utils.g2p.mandarin import number_to_chinese, chinese_to_bopomofo, latin_to_bopomofo, chinese_to_romaji, chinese_to_lazy_ipa, chinese_to_ipa, chinese_to_ipa2
from app.vallex.utils.g2p.english import english_to_lazy_ipa, english_to_ipa2, english_to_lazy_ipa2
